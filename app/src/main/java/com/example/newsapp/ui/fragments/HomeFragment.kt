...
class HomeFragment : Fragment() {
    ...
    private fun setAdapter(articles: List<Article>) {
        val adapter = TopHeadlinesAdapter{findNavController().navigate(R.id.action_homeFragment_to_singleArticleFragment,it)}
        adapter.submitList(articles)
        binding.recyclerTopHeadlines.layoutManager = LinearLayoutManager(requireContext(),LinearLayoutManager.HORIZONTAL,false)
